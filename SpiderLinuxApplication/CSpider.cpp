...
void CSpider::MoveTripodSingleStep(TRIPOD_ID Tripod,CSpiderLeg::JOINT_ID Joint,float AngleF,float AngleM,float AngleB) {
	if(Tripod == 0)
	{
		/* if (Joint == CSpiderLeg::Knee) {
			m_szLeg[LEG_RF]->MoveJoint(Joint,AngleF + .5);
		} */
		m_szLeg[LEG_RF]->MoveJoint(Joint,AngleF);
		//WaitReady(ReadyTime());
		/* if (Joint == CSpiderLeg::Knee) {
			m_szLeg[LEG_LM]->MoveJoint(Joint,AngleM - .5);
		} */
		m_szLeg[LEG_LM]->MoveJoint(Joint,AngleM);
		//WaitReady(ReadyTime());
		if (Joint == CSpiderLeg::Knee)
...
void CSpider::testing(uint8_t Repeat_Num) {
	 if (m_bDebugDump)
	  printf("MoveForward \n");
	...
	for(num=0;num<Repeat_Num && m_bAbort!= true;num++)
	{
		/*MoveTripodSingleStep(TRIPOD1,CSpiderLeg::Knee,Knee_Up_Base,Knee_Up_Base,Knee_Up_Base);
		WaitReady(ReadyTime());
		MoveTripodSingleStep(TRIPOD1,CSpiderLeg::Hip,HipF_Base+20,HipM_Base+20,HipB_Base+20);
		MoveTripodSingleStep(TRIPOD2,CSpiderLeg::Hip,HipF_Base-20,HipM_Base-20,HipB_Base-20);
		WaitReady(ReadyTime());
		MoveTripodSingleStep(TRIPOD1,CSpiderLeg::Knee,Knee_Down_Base,Knee_Down_Base,Knee_Down_Base);
		WaitReady(ReadyTime());
		MoveTripodSingleStep(TRIPOD2,CSpiderLeg::Knee,Knee_Up_Base,Knee_Up_Base,Knee_Up_Base);
		WaitReady(ReadyTime());
		MoveTripodSingleStep(TRIPOD1,CSpiderLeg::Hip,HipF_Base-20,HipM_Base-20,HipB_Base-20);
		MoveTripodSingleStep(TRIPOD2,CSpiderLeg::Hip,HipF_Base+20,HipM_Base+20,HipB_Base+20);
		WaitReady(ReadyTime());
		...
		m_szLeg[LEG_RM]->MoveJoint(CSpiderLeg::Ankle,Ankle_Base-50);
		m_szLeg[LEG_RB]->MoveJoint(CSpiderLeg::Ankle,Ankle_Base-70);
		m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Ankle,Ankle_Base-40);
		m_szLeg[LEG_LM]->MoveJoint(CSpiderLeg::Ankle,Ankle_Base-50);//
		m_szLeg[LEG_LB]->MoveJoint(CSpiderLeg::Ankle,Ankle_Base-70);//
		/////////////////////////////////////////////////////////////////
		MoveTripodSingleStep(TRIPOD1,CSpiderLeg::Knee,Knee_Up_Base+30,Knee_Up_Base+30,(Knee_Up_Base+30)-20);//
		WaitReady(ReadyTime());
		MoveTripodSingleStep(TRIPOD1,CSpiderLeg::Hip,HipF_Base+20,HipM_Base+20,HipB_Base+20);
		MoveTripodSingleStep(TRIPOD2,CSpiderLeg::Hip,HipF_Base-20,HipM_Base-20,HipB_Base-20);
		WaitReady(ReadyTime());
		MoveTripodSingleStep(TRIPOD1,CSpiderLeg::Knee,(Knee_Down_Base-30)+10,(Knee_Down_Base-30)+20,(Knee_Down_Base-30)-50);
		WaitReady(ReadyTime());
		MoveTripodSingleStep(TRIPOD2,CSpiderLeg::Knee,Knee_Up_Base+30,Knee_Up_Base+30,(Knee_Up_Base+30)-20);
		WaitReady(ReadyTime());
		MoveTripodSingleStep(TRIPOD1,CSpiderLeg::Hip,HipF_Base-20,HipM_Base-20,HipB_Base-20);
		MoveTripodSingleStep(TRIPOD2,CSpiderLeg::Hip,HipF_Base+20,HipM_Base+20,HipB_Base+20);
		WaitReady(ReadyTime());
		MoveTripodSingleStep(TRIPOD2,CSpiderLeg::Knee,(Knee_Down_Base-30)+10,(Knee_Down_Base-30)+20,(Knee_Down_Base-30)-50);
		WaitReady(ReadyTime());
		
		////////////////////////////////////////////////////////
		
		/*HIP THRUST
		m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Hip,HipB_Base-20);
		m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Hip,HipB_Base-20);
		m_szLeg[LEG_RM]->MoveJoint(CSpiderLeg::Hip,HipB_Base-20);
		m_szLeg[LEG_LM]->MoveJoint(CSpiderLeg::Hip,HipB_Base-20);
		m_szLeg[LEG_RB]->MoveJoint(CSpiderLeg::Hip,HipB_Base-20);
		m_szLeg[LEG_LB]->MoveJoint(CSpiderLeg::Hip,HipB_Base-20);
		WaitReady(ReadyTime());
		...
		m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Knee,Knee_Up_Base);
		WaitReady(ReadyTime());
		m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Hip,HipB_Base);
		WaitReady(ReadyTime());
		m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Knee,Knee_Down_Base);
		WaitReady(ReadyTime());
		...
		m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Knee,Knee_Up_Base);
		WaitReady(ReadyTime());
		m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Hip,HipB_Base);
		WaitReady(ReadyTime());
		m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Knee,Knee_Down_Base);
		WaitReady(ReadyTime());
		...
		//Middle hips go forward
		m_szLeg[LEG_RM]->MoveJoint(CSpiderLeg::Hip,HipB_Base);
		m_szLeg[LEG_LM]->MoveJoint(CSpiderLeg::Hip,HipB_Base);
		WaitReady(ReadyTime());
